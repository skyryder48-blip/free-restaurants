--[[
    free-restaurants POS/Ordering System Configuration
...
print('[free-restaurants] Loading config/pos_order.lua...')
...
print('[free-restaurants] config/pos_order.lua loaded successfully')
